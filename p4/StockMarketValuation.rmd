...
The mean CAGRS are all lower than the mean 1 year return.
...
Log transformations were applied to many of the visualizations to reduce postive
skew. They are also a natural transformation to apply because they convert the
expontential growth of continuous componding into an additive one.
